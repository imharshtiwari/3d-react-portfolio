...
const Contact = () => {
  ...
  //         to_email: "harsh.rathi1710@gmail.com",
      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a href="mailto:harshtiwari.me@gmail.com" target="_blank" className="blue-text-gradient">harshtiwari.me@gmail.com</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
            <a href="https://api.whatsapp.com/send/?phone=918896523607&text&app_absent=0&lang=en" target="_blank" className="blue-text-gradient">
              +91 8896523607
            </a>
          </article>
        </div>
